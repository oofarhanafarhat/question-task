...
console.log(`Titlecase: ${sname.charAt(0).toUpperCase() + sname.slice(1).toLowerCase()}`);
...
let famousPerson = "A person who never made a mistake never tried anything new";
...
let names = ["nabeel", "abdullah", "azlan", "shujaat", "humza"];
...
console.log(`Dear ${sguests[0]}, I would be honored if you could join me for dinner. Let's discuss art, science, and the wonders of the universe!`);
console.log(`Dear ${sguests[1]}, I would be honored if you could join me for dinner. Let's discuss art, science, and the wonders of the universe!`);
console.log(`Dear ${sguests[2]}, I would be honored if you could join me for dinner. Let's discuss art, science, and the wonders of the universe!`);
console.log(`Dear ${sguests[3]}, I would be honored if you could join me for dinner. Let's discuss art, science, and the wonders of the universe!`);
console.log(`Dear ${sguests[4]}, I would be honored if you could join me for dinner. Let's discuss art, science, and the wonders of the universe!`);
...
let guests1 = ["S.M TAHA ALI", "WAJAHAT KHAN", "ARYAN ULLAH KHAN"];
console.log(`Dear ${guests1[0]}, I would be honored if you could join me for dinner. Let's discuss art, science, and innovation!`);
console.log(`Dear ${guests1[1]}, I would be delighted if you could join me for dinner. Your art and perspective would be fascinating to discuss!`);
console.log(`Dear ${guests1[2]}, I would be thrilled if you could join me for dinner. Let's explore the wonders of the universe together!`);
// Changing Guest List: You just heard that one of your guests can’t make the dinner, so you need to send out a new set of invitations. You’ll have to think of someone else to invite.
let guests2 = ["S.M TAHA ALI", "WAJAHAT KHAN", "ARYAN ULLAH KHAN"];
guests2.pop();
guests2.push("ARBAB KHAN");
console.log(`Dear ${guests2[0]}, I would be honored if you could join me for dinner. Let's discuss art, science, and innovation!`);
console.log(`Dear ${guests2[1]}, I would be delighted if you could join me for dinner. Your art and perspective would be fascinating to discuss!`);
console.log(`Dear ${guests2[2]}, I would be thrilled if you could join me for dinner. Let's explore the wonders of the universe together!`);
// • Start with your program from Exercise 14. Add a print statement at the end of your program stating the name of the guest who can’t make it.
let guests3 = ["MS.RABIA", "MS. FARIDA", "MS.SHAHEEN"];
console.log(`Dear ${guests3[0]}, I would be honored if you could join me for dinner. Let's discuss art, science, and innovation!`);
console.log(`Dear ${guests3[1]}, I would be delighted if you could join me for dinner. Your art and perspective would be fascinating to discuss!`);
console.log(`Dear ${guests3[2]}, I would be thrilled if you could join me for dinner. Let's explore the wonders of the universe together!`);
// Guest who can't make it
let cancelledGuest3 = "MS.SHAEEN";
guests3.pop();
console.log(`Unfortunately, ${cancelledGuest3} can't make it to dinner. Let's catch up another time!`);
// New guest invitation
let newGuest = "MS .MARIA";
guests3.push(newGuest);
console.log(`Dear ${guests3[2]}, I would be thrilled if you could join me for dinner. Let's talk about groundbreaking discoveries and pioneering women in science!`);
// • Modify your list, replacing the name of the guest who can’t make it with the name of the new person you are inviting.
let guests = ["Ms.noreen", "MS.farheen", "MS.ambreen"];
console.log(`Dear ${guests[0]}, I would be honored if you could join me for dinner. Let's discuss art, science, and innovation!`);
console.log(`Dear ${guests[1]}, I would be delighted if you could join me for dinner. Your art and perspective would be fascinating to discuss!`);
console.log(`Dear ${guests[2]}, I would be thrilled if you could join me for dinner. Let's explore the wonders of the universe together!`);
// Guest who can't make it
let cancelledGuest = guests[1];
console.log(`Unfortunately, ${cancelledGuest} can't make it to dinner. Let's catch up another time!`);
// Replace with new guest
guests[1] = "Mrs .sadaf";
console.log(`Dear ${guests[0]}, I would be honored if you could join me for dinner. Let's discuss art, science, and innovation!`);
console.log(`Dear ${guests[1]}, I would be delighted if you could join me for dinner. Your art and perspective would be fascinating to discuss!`);
console.log(`Dear ${guests[2]}, I would be thrilled if you could join me for dinner. Let's talk about groundbreaking discoveries and pioneering women in science!`);
...
let newguest = ["ms.rosheana", "MS.shagufta", "MS.nelofer"];
...
let newguest1 = ["ms.rosheana", "MS.shagufta", "MS.nelofer"];
...
// Initial guest list
let guest = ["zobia", "kulsoom", "naima", "naseem"];
...
let placesToVisit = ["Tokyo", "pakistan", "sawat", "Paris", "Sydney"];
...
// Dinner Guests
let dinnerGuests = ["saba", "zoia", "mahreen", "shabana"];
...
// Function to check username availability
function checkUser1(usernames3) {
...
function make_great2(magicians2) {
    return magicians2.map((magicians) => `The Great ${magicians2}`);
}
console.log("Original List:");
...
function createCar1(manufacturer, model, ...options) {
    const car = {
        manufacturer,
        model,
    };
...
const car1 = createCar1("Toyota", "Camry", { color: "blue" }, { feature: "Sunroof" });
const car2 = createCar1("Honda", "Civic", { color: "Red" }, { feature: "GPS" });
console.log(car1);
console.log(car2);
